...
# 设置工作路径
WORK_DIR="/home/liuycomputing/wsp_sequencing/Live-Cell-Data-Storage/test_data"
EXP_DIR="${WORK_DIR}/downsampling_experiments"
FILE_NAME="one_primer"
ORIGINAL_FILE="${WORK_DIR}/${FILE_NAME}.fastq"
...
# 实验参数
TARGET_DEPTHS=(5 10 15 30 50 100 150 200)
REPLICATES=10
