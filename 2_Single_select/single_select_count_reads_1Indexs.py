...
def main(args):
    ...
    single_ids_list = args.single_ids_list
    ...
    for fastq_file in fastq_files:
        ...
        for _, sequence, _, quality in read_fastq(fastq_file):
            ...
            # 直接根据 index 进行匹配
            best_score = -1
            for index, ideal_seq in enumerate(library[search_ids]):
            ...
            if index_score == len(sub_read_seq):  # 能够找到完全匹配的索引
                ...
                if payload_score < 55:  # payload相似度不符合条件，找相似的 unique，获得对应的索引和序列
...
if __name__ == '__main__':
    ...
    parser.add_argument('--library_file', type=str, 
                        default='/home/liuycomputing/wsp_sequencing/data/FINAL.xlsx')
    
    parser.add_argument('--fastq_folder', type=str,
                        default='/home/liuycomputing/wsp_sequencing/data/seq_20251217/single_select/downsampling_experiments/subsampled_fastq/')
    parser.add_argument('--fastq_name', type=str,
                        default='BG-JX29_1_depth_30x')
    parser.add_argument('--single_ids_list', type=list, default=[30000 - 1])
    ...
    parser.add_argument('--output_folder', type=str,
                        default='/home/liuycomputing/wsp_sequencing/codes/process_20251218/single_select/')
    parser.add_argument('--output_file_name', type=str,
                        default='single_select_ID30000_count_reads_for_perfect_recovery.pkl')
